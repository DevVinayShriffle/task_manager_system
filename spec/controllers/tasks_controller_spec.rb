...
RSpec.describe TasksController, type: :controller do
  ...
  #       patch :update, params: {task: valid_params}, format: :html
  ...
  #       patch :update, params: {task: valid_params}, format: :json
  ...
  #     context 'when referrer exists' do
  #       before do
  #         request.env("HTTP_REFERER") = users_tasks_path(@task)
  #       end

  #       it "fails creation (HTML)" do
  #         post :update, params: { task: invalid_params }, format: :html
  ...
  #       it "fails creation (JSON)" do
  #         post :update, params: { task: invalid_params }, format: :json
